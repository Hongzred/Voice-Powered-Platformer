...
import MapJSON from "../assets/VPP-level3.json";
...
export default class Level3 extends Phaser.Scene 
{
    ...
    static SCENE_NAME = 'LEVEL_3';
    static TILE_SET_KEY = 'LEVEL_3_TILEMAP';
    ...
    preload()
    {
        ...
        //  Map sprites
        this.load.image(Level3.INTRO_TILE_SET_SPRITE, introTileSet);
        this.load.image(Level3.DEMO_TILE_SET_SPRITE, demoTileSet);

        //  Map from Tiled
        this.load.tilemapTiledJSON(Level3.TILE_SET_KEY, MapJSON);
    ...
    create()
    {
        ...
        //  Add level overlay
        this.add
            .existing(new Overlay(this, Level3.SCENE_NAME));

        //  Create layout
        this.map = this.make.tilemap({
            key: Level3.TILE_SET_KEY,
            tileWidth: 32,
            tileHeight: 32
        });
        ...
        this.map.createStaticLayer(
            Level3.LAYER_NAMES.Water,
            this.map.addTilesetImage(Level3.INTRO_TILE_SET_NAME, Level3.INTRO_TILE_SET_SPRITE, 8, 8),
            0, 0)
            .setDepth(Level3.DEPTH.Water);

        //  Create ground
        this.map.createStaticLayer(
            Level3.LAYER_NAMES.Ground,
            this.map.addTilesetImage(Level3.INTRO_TILE_SET_NAME, Level3.INTRO_TILE_SET_SPRITE, 8, 8),
            0, 0)
            .setDepth(Level3.DEPTH.Ground);

         //  Create bottom wall layer
        const bottomWallLayer = this.map.createStaticLayer(
            Level3.LAYER_NAMES.Walls_Bottom,
            this.map.addTilesetImage(Level3.DEMO_TILE_SET_NAME, Level3.DEMO_TILE_SET_SPRITE, 8, 8),
            0, 0)
            .setDepth(Level3.DEPTH.Walls_Bottom);
        ...
        const topWallLayer  = this.map.createStaticLayer(
            Level3.LAYER_NAMES.Walls_Top,
            this.map.addTilesetImage(Level3.DEMO_TILE_SET_NAME, Level3.DEMO_TILE_SET_SPRITE, 8, 8),
            0, 0)
            .setDepth(Level3.DEPTH.Walls_Top);
        ...
        const boundsLayer  = this.map.createStaticLayer(
            Level3.LAYER_NAMES.Bounds,
            this.map.addTilesetImage(Level3.INTRO_TILE_SET_NAME, Level3.INTRO_TILE_SET_SPRITE, 8, 8),
            0, 0)
            .setDepth(Level3.DEPTH.Bounds);
        ...
        const exitLayer = this.map.createStaticLayer(
            Level3.LAYER_NAMES.Exit,
            this.map.addTilesetImage(Level3.INTRO_TILE_SET_NAME, Level3.INTRO_TILE_SET_SPRITE, 8, 8),
            0, 0)
            .setDepth(Level3.DEPTH.Exit);
        ...
        this.player = this.add.existing(new TestObject(
            ...
            Level3.START_X,
            Level3.START_Y,
            Level3.PLAYER_IMAGE_KEY));
        this.physics.add.existing(this.player);
        this.player
            .setAngle(180)
            .setDepth(Level3.DEPTH.Player);
        ...
        this.commandQueue = this.add
            .existing(new TestObject.ActionQueue(
                this.physics.world, this, this.player, Level3.DEPTH.CommandsQueue,
        ...
        this.cameras
            .main
            .setBounds(0, 0, Level3.MAP_WIDTH, Level3.MAP_HEIGHT)
        ...
        if (tile.index >= 0)
        {
            if (!this.exitReached)
            {
                ...
                const clearSceneData = {
                    parentSceneName: Level3.SCENE_NAME
                };
